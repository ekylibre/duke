...
**Couverture tests** : 387 tests par défaut (unit + integration testcontainers) + 6 e2e opt-in contre Ekylibre tournant + 1 smoke training opt-in. Le widget JS n'a pas de suite Jest — validation manuelle dans Chrome/Edge (Firefox sans Web Speech API : le bouton est masqué).
...
- **Whisper STT serveur** : alternative à Web Speech API si la qualité navigateur déçoit en environnement bruyant (tracteur, vent).
